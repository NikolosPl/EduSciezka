...
// Pobierz zadania
$wynik_zadan = mysqli_query($polaczenie,
...
$wynik_terminow = mysqli_query($polaczenie,
...
$wynik_logow = mysqli_query($polaczenie,
...
<div class="tresc">
    ...
    if ($komunikat != "") {
        ...
        if ($typ_kom == "sukces") echo '<div class="kom-sukces">' . htmlspecialchars($tresc_kom) . '</div>';
        else echo '<div class="kom-blad">' . htmlspecialchars($tresc_kom) . '</div>';
    }
    ?>
            ...
            <table>
                ...
                <tr>
                    <td>
                        ...
                        <?php if ($zad['opis']): ?>
                            <br><small style="color:#9ca3af"><?php echo htmlspecialchars(substr($zad['opis'], 0, 60)); ?></small>
                        <?php endif; ?>
                    </td>
                    <td>
                    ...
                    <td style="font-size:12px;color:#6b7280">
                        ...
                        if ($zad['status'] != 'zakonczone') {
                            if ($roznica < 0) echo '<br><span style="color:#b91c1c;font-weight:bold">Po terminie!</span>';
                            elseif ($roznica < 86400) echo '<br><span style="color:#f59e0b;font-weight:bold">Dzisiaj!</span>';
                            elseif ($roznica < 86400 * 3) echo '<br><span style="color:#f59e0b">Za ' . round($roznica / 86400) . ' dni</span>';
                        }
                        ?>
                    </td>
                    <td>
        ...
        <div style="padding:0">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td style="font-size:12px"><?php echo htmlspecialchars($ter['nauczyciel'] ? $ter['nauczyciel'] : '—'); ?></td>
                    <td style="font-size:12px;color:#6b7280"><?php echo date('d.m.Y H:i', strtotime($ter['data_termin'])); ?></td>
                    <td>
