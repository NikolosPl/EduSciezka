...
$wynik_projektow = mysqli_query($polaczenie,
    ...
    <div class="projekty-lista">
        ...
        <div class="projekt-karta status-<?php echo $s_css; ?>">
            <div class="projekt-gora">
                ...
                <span class="priorytet priorytet-<?php echo $proj['priorytet']; ?>"><?php echo ucfirst($proj['priorytet']); ?></span>
            </div>
            ...
            <div class="projekt-meta">
                ...
                if ($s != 'zakończony' && $s != 'porzucony') {
                    if ($dni < 0) echo ' <span style="color:#b91c1c">— po terminie!</span>';
                    elseif ($dni <= 7) echo ' <span style="color:#f59e0b">— zostalo ' . $dni . ' dni</span>';
                }
                ?>
            </div>
